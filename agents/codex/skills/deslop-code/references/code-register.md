...
**Hard-ban (overrides the Tier-2 "never hard-ban" default): `load-bearing`.** It reads as a strong model tell. Always replace it rather than merely flagging: name what actually depends on the thing, or use "critical"/"essential".
